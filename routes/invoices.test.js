...
describe("GET /1", () => {
  ...
  test("It should return 404 if the invoice exist", async () => {
...
describe("PUT /", () => {
  ...
  test("It should return 404 if the invoice does not exist", async () => {
    const response = await request(app)
        .put("/invoices/9999")
        .send({amt: 1000});
...
describe("DELETE /", () => {
  ...
  test("It should return 404 if the invoice doesnt exist", async () => {
    const response = await request(app)
        .delete("/invoices/999");
